...
parser.add_argument('--mode', type=str, choices=['train', 'test',  'ensemble', 'visiual'])
...
parser.add_argument('--add_dg', default=False, action="store_true")
parser.add_argument('--dg_type', type=str, default="final_agg")
parser.add_argument('--final', type=str, default="multiscale")
...
parser.add_argument('--alpha', default=1.0, type=float,
                    help='adv weight')
parser.add_argument('--lr_steps', default=[30, 60, 120], type=float, nargs="+",
